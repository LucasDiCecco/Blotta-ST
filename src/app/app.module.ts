...
const routes: Routes = [
    ...
    {path:'fallas', component: FallasComponent},
        {path:'fallas/MCE1', component: MCE1Component, canActivate: [AuthGuard]},
        {path:'fallas/FH200', component: FH200Component, canActivate: [AuthGuard]},
        {path:'fallas/UTL63', component: UTL63Component, canActivate: [AuthGuard]},
        {path:'fallas/M70', component: M70Component, canActivate: [AuthGuard]},
